...
var colorSky = "#CCEEFF";
var colorAliceBlue = "#F0F8FF";
var colorBisque = "#FFE4C4";
var colorChocolate = "#7FFF00";
var colorDarkGray = "#A9A9A9";
var colorAqua = "#00FFFF";
...
// Strating picture area
var drawingAreaX = 128;
var drawingAreaY = 30;
// Drawing area width
var drawingAreaWidth = 540;
var drawingAreaHeight = 535;
...
*/
function prepareCanvas(img_src)
{
	...
	// Add mouse events
    // ----------------
	var my_canvas = document.getElementsByTagName('canvas')[0];
	...
	my_canvas.onmouseleave = function (e) {
		paint = false;
	};
}
...
function redraw()
{
	...
	if(curTool == "crayon")
	{
	    ...
	    // Black
		locX = (curColor == colorBlack) ? 18 : 52;
		locY += 46;
	    ...
	    // AliceBlue
		locX = (curColor == colorAliceBlue) ? 18 : 52;
		locY += 46;
		...
		context.lineTo(locX + 41, locY + 11);
		context.closePath();
		context.fillStyle = colorAliceBlue;
		context.fill();

		if (curColor == colorAliceBlue) {
		    context.drawImage(crayonImage, locX, locY, mediumImageWidth, mediumImageHeight);
		} else {
		    context.drawImage(crayonImage, 0, 0, 59, mediumImageHeight, locX, locY, 59, mediumImageHeight);
		}
	    ...
	    // Bisque
		locX = (curColor == colorBisque) ? 18 : 52;
		locY += 46;
		...
		context.lineTo(locX + 41, locY + 11);
		context.closePath();
		context.fillStyle = colorBisque;
		context.fill();

		if (curColor == colorBisque) {
		    context.drawImage(crayonImage, locX, locY, mediumImageWidth, mediumImageHeight);
		} else {
		    context.drawImage(crayonImage, 0, 0, 59, mediumImageHeight, locX, locY, 59, mediumImageHeight);
		}
	    ...
	    // Chocolate 
		locX = (curColor == colorChocolate) ? 18 : 52;
		locY += 46;
		...
		context.lineTo(locX + 41, locY + 11);
		context.closePath();
		context.fillStyle = colorChocolate;
		context.fill();

		if (curColor == colorChocolate) {
		    context.drawImage(crayonImage, locX, locY, mediumImageWidth, mediumImageHeight);
		} else {
		    context.drawImage(crayonImage, 0, 0, 59, mediumImageHeight, locX, locY, 59, mediumImageHeight);
		}
	    ...
	    // DarkGray
		locX = (curColor == colorDarkGray) ? 18 : 52;
		locY += 46;
		...
		context.lineTo(locX + 41, locY + 11);
		context.closePath();
		context.fillStyle = colorDarkGray;
		context.fill();

		if (curColor == colorDarkGray) {
		    context.drawImage(crayonImage, locX, locY, mediumImageWidth, mediumImageHeight);
		} else {
		    context.drawImage(crayonImage, 0, 0, 59, mediumImageHeight, locX, locY, 59, mediumImageHeight);
		}
		...
		context.lineTo(locX + 41, locY + 11);
		context.closePath();
		context.fillStyle = colorAqua;
		context.fill();

		if (curColor == colorAqua) {
		    context.drawImage(crayonImage, locX, locY, mediumImageWidth, mediumImageHeight);
		} else {
		    context.drawImage(crayonImage, 0, 0, 59, mediumImageHeight, locX, locY, 59, mediumImageHeight);
		}
